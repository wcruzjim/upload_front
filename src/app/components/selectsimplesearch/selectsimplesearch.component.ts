...
@Component({
  selector: 'app-selectsimplesearch',
  templateUrl: './selectsimplesearch.component.html',
  styleUrls: ['./selectsimplesearch.component.scss']
})
export class SelectsimplesearchComponent implements OnInit {
        ...
        if (data.elements.length > 0) {
          ...
          if (typeof data.selected != 'undefined') {
            this.banks.forEach((e,i)=>{
              if (e[this.id] == data.selected[this.id]) {
                valuesSelected = e
              }
            })
